    ...
    <div className="w-full">
      <div className="mb-8 flex flex-col gap-y-4">
        ...
        <p className="text-base-regular">
          Revisa y actualiza la información de perfil, incluyendo tu nombre, email,
          y número de teléfono. Además, puedes cambiar la dirección de facturación y tu contraseña.
        </p>
      </div>
