...
const Hero = () => {
  ...
  return (
    <div className="h-[80vh] small:h-[75vh] w-full relative bg-ui-bg-subtle overflow-hidden">
      <div className="flex flex-col small:flex-row h-[520px] small:h-full bg-black justify-end small:justify-between mt-0 small:mt-16 items-center relative">
        ...
        <img
          src="/images/hero.svg"
          alt="fondo"
          className="w-full small:w-[700px] h-[520px] small:h-full absolute small:relative z-10 object-cover filter brightness-50 small:brightness-75"
        />
      </div>
    </div>
  )
